...
var temp__5718__auto___33293 = event.state;
if(cljs.core.truth_(temp__5718__auto___33293)){
var state_33294 = temp__5718__auto___33293;
var temp__5720__auto___33295 = (state_33294["scroll-top"]);
if(cljs.core.truth_(temp__5720__auto___33295)){
var scroll_top_33296 = temp__5720__auto___33295;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,((function (scroll_top_33296,temp__5720__auto___33295,state_33294,temp__5718__auto___33293){
return (function (){
scrollTo((0),scroll_top_33296);

return null;
});})(scroll_top_33296,temp__5720__auto___33295,state_33294,temp__5718__auto___33293))
);
} else {
}
} else {
...
var scroll_top_33297 = clerk.core.get_scroll_top.call(null);
var state_33298 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_33297], null);
history.replaceState(cljs.core.clj__GT_js.call(null,state_33298),document.title);
...
var len__4641__auto___33305 = arguments.length;
var i__4642__auto___33306 = (0);
while(true){
if((i__4642__auto___33306 < len__4641__auto___33305)){
args__4647__auto__.push((arguments[i__4642__auto___33306]));

var G__33307 = (i__4642__auto___33306 + (1));
i__4642__auto___33306 = G__33307;
continue;
} else {
}
break;
...
clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__33301){
var vec__33302 = p__33301;
var top_element_id = cljs.core.nth.call(null,vec__33302,(0),null);
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33302,top_element_id){
return (function (){
return clerk.core.scroll_to.call(null,y);
});})(y,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33302,top_element_id))
);
}
} else {
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y_translation,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33302,top_element_id){
return (function (){
...
});})(y_translation,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33302,top_element_id))
);
}
}
});
...
/** @this {Function} */
clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq33299){
var G__33300 = cljs.core.first.call(null,seq33299);
var seq33299__$1 = cljs.core.next.call(null,seq33299);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33300,seq33299__$1);
});
...
//# sourceMappingURL=core.js.map?rel=1548047560115
