...
return (new CustomEvent(event_name,(function (){var obj34857 = {"detail":data};
return obj34857;
})()));
} else {
...
var f = (function (){var pred__34864 = cljs.core._EQ_;
var expr__34865 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34864.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34865))){
return ((function (pred__34864,expr__34865){
return (function (p1__34858_SHARP_){
return console.warn(p1__34858_SHARP_);
});
;})(pred__34864,expr__34865))
} else {
if(cljs.core.truth_(pred__34864.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34865))){
return ((function (pred__34864,expr__34865){
return (function (p1__34859_SHARP_){
return console.debug(p1__34859_SHARP_);
});
;})(pred__34864,expr__34865))
} else {
if(cljs.core.truth_(pred__34864.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34865))){
return ((function (pred__34864,expr__34865){
return (function (p1__34860_SHARP_){
return console.error(p1__34860_SHARP_);
});
;})(pred__34864,expr__34865))
} else {
return ((function (pred__34864,expr__34865){
return (function (p1__34861_SHARP_){
return console.log(p1__34861_SHARP_);
});
;})(pred__34864,expr__34865))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34868){
...
var eval_fn = cljs.core.get.call(null,map__34869__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__34871_SHARP_){
return new_def.callback(p1__34871_SHARP_);
});})(new_def))
);
...
var vec__34873 = p__34872;
var ky = cljs.core.nth.call(null,vec__34873,(0),null);
var v = cljs.core.nth.call(null,vec__34873,(1),null);
...
}catch (e34878){if((e34878 instanceof Error)){
var e = e34878;
return not_found;
} else {
throw e34878;
...
//# sourceMappingURL=utils.js.map?rel=1548047567508
