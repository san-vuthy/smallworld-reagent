...
var o29226 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29226["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29227 = temp__5718__auto____$1;
return (o29227["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28884__auto__ = f;
return (o__28884__auto__["toString"]).call(o__28884__auto__);
} else {
return "";
}
}catch (e29228){var _ = e29228;
return "";
}});
...
try{var o__28884__auto___29230 = t;
(o__28884__auto___29230["cljs$lang$ctorPrWriter"]).call(o__28884__auto___29230,t,writer);
}catch (e29229){var __29231 = e29229;
}
...
var char_code = (function (){var o__28884__auto__ = (new String(char$));
return (o__28884__auto__["charCodeAt"]).call(o__28884__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28884__auto__ = String;
return (o__28884__auto__["fromCharCode"]).call(o__28884__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29232 = num_code;
switch (G__29232) {
case (1):
return (185);
...
var o__28884__auto__ = String;
return (o__28884__auto__["fromCharCode"]).call(o__28884__auto__,superscript_code);
});
/**
...
}catch (e29234){var _e__28891__auto__ = e29234;
return false;
}})())){
...
var vec__29235 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29235,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o29238 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29238["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29239 = temp__5718__auto____$1;
return (o29239["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___29246 = arguments.length;
var i__4642__auto___29247 = (0);
while(true){
if((i__4642__auto___29247 < len__4641__auto___29246)){
args__4647__auto__.push((arguments[i__4642__auto___29247]));

var G__29248 = (i__4642__auto___29247 + (1));
i__4642__auto___29247 = G__29248;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29242){
var vec__29243 = p__29242;
var ns_detector = cljs.core.nth.call(null,vec__29243,(0),null);
...
var G__29249 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29250 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29249;
remaining_tokens = G__29250;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29240){
var G__29241 = cljs.core.first.call(null,seq29240);
var seq29240__$1 = cljs.core.next.call(null,seq29240);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29241,seq29240__$1);
});
...
var vec__29254 = cljs.core.split_with.call(null,(function (p1__29253_SHARP_){
return cljs.core.not_EQ_.call(null,p1__29253_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__29254,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__29254,(1),null);
...
var vec__29257 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__29257,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__29257,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__29260 = cljs.core.rest.call(null,remaining_tokens);
var G__29261 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__29260;
name_tokens = G__29261;
continue;
} else {
...
var vec__29264 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__29264,(0),null);
var arity = cljs.core.nth.call(null,vec__29264,(1),null);
var vec__29267 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__29267,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__29267,(1),null);
var vec__29270 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__29270,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__29270,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__29270,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__29270,(3),null);
...
var vec__29276 = result;
var munged_ns = cljs.core.nth.call(null,vec__29276,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__29276,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__29276,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__29276,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__29276,(4),null);
var arity = cljs.core.nth.call(null,vec__29276,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__29280 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__29280,(0),null);
var args = cljs.core.nth.call(null,vec__29280,(1),null);
var vec__29283 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29283,(0),null);
var name = cljs.core.nth.call(null,vec__29283,(1),null);
...
var G__29286 = (arity + (1));
var G__29287 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29288){
var vec__29289 = p__29288;
var arity = cljs.core.nth.call(null,vec__29289,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29289,(1),null);
...
return cljs.core.get.call(null,arities,p1__29292_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29293_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___29300 = arguments.length;
var i__4642__auto___29301 = (0);
while(true){
if((i__4642__auto___29301 < len__4641__auto___29300)){
args__4647__auto__.push((arguments[i__4642__auto___29301]));

var G__29302 = (i__4642__auto___29301 + (1));
i__4642__auto___29301 = G__29302;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29296){
var vec__29297 = p__29296;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29297,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29294){
var G__29295 = cljs.core.first.call(null,seq29294);
var seq29294__$1 = cljs.core.next.call(null,seq29294);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29295,seq29294__$1);
});
...
var map__29305 = options;
var map__29305__$1 = (((((!((map__29305 == null))))?(((((map__29305.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29305.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29305):map__29305);
var include_ns_QMARK_ = cljs.core.get.call(null,map__29305__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29305__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29305__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29305__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29306 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29306,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29306,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29306,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29306,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29306,(4),null);
var arity = cljs.core.nth.call(null,vec__29306,(5),null);
...
var o__28884__auto__ = f;
return (o__28884__auto__["getBasis"]).call(o__28884__auto__);
});
/**
...
}catch (e29310){var _e__28891__auto__ = e29310;
...
var G__29311 = (obj[cljs.core.first.call(null,path)]);
var G__29312 = cljs.core.rest.call(null,path);
obj = G__29311;
path = G__29312;
continue;
} else {
...
return (function (accum,p__29313){
var vec__29314 = p__29313;
var bit = cljs.core.nth.call(null,vec__29314,(0),null);
var protocol = cljs.core.nth.call(null,vec__29314,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29317){
var vec__29318 = p__29317;
var ns = cljs.core.nth.call(null,vec__29318,(0),null);
var name = cljs.core.nth.call(null,vec__29318,(1),null);
var selector = cljs.core.nth.call(null,vec__29318,(2),null);
...
return (function (p__29322){
var vec__29323 = p__29322;
var munged_name = cljs.core.nth.call(null,vec__29323,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29323,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29323,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29321_SHARP_){
return (obj[cljs.core.first.call(null,p1__29321_SHARP_)]);
});})(name,sorted_matches,vec__29323,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1548047551837
