...
}catch (e34355){var _e = e34355;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___34358 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___34358)){
var seen_errors_34359 = temp__5718__auto___34358;
if(cljs.core.truth_(seen_errors_34359.has(self))){
} else {
seen_errors_34359.add(self);

var temp__5720__auto___34360 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___34360)){
var sense_34361 = temp__5720__auto___34360;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34361)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1548047564595
